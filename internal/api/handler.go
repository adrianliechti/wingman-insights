...
func (h *Handler) Register(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/traces/spans", h.spans)
	...
	mux.HandleFunc("GET /api/finops/what-if", h.whatIf)
	mux.HandleFunc("GET /api/finops/pricing-models", h.pricingModels)
	...
	mux.HandleFunc("GET /api/http/error-rate", h.httpErrorRate)
	mux.HandleFunc("GET /api/http/errors-by-code", h.httpErrorsByCode)
	mux.HandleFunc("GET /api/http/top-routes", h.topRoutes)
	mux.HandleFunc("GET /api/http/method-distribution", h.methodDistribution)
}
